...
public class AvailabilitySlotDTO {
    ...
    /** True when a confirmed/pending appointment already occupies this slot. */
    private boolean hasConflict;
    /** Day-of-week label for weekly recurring slots (MONDAY…SUNDAY). */
    private String dayOfWeek;
    /** Whether this slot is available (for weekly grid saves). */
    ...
    public static AvailabilitySlotDTO from(AvailabilitySlot slot) {
        return AvailabilitySlotDTO.builder()
                ...
                .available(slot.getStatus() == AvailabilitySlot.SlotStatus.AVAILABLE)
                .build();
    }
}
