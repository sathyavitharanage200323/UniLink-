...
export function ProfilePage({ currentUser, onLogout, onUserUpdate }) {
  ...
  // DND Settings state (for lecturers only)
      ...
      <main style={{ flex: 1, maxWidth: 860, margin: '0 auto', width: '100%', padding: '28px 16px' }}>
        ...
        <section style={{ marginTop: 14, background: 'white', border: '1px solid #e2e8f0', borderRadius: 16, padding: 20 }}>
          ...
          <div style={{ marginTop: 16, display: 'grid', gap: 8, color: '#334155' }}>
            ...
            <div><strong>Email:</strong> {currentUser?.email || 'Not available in demo list'}</div>
            {currentUser?.expertise && <div><strong>Expertise:</strong> {currentUser.expertise}</div>}
          </div>
        </section>

        {/* Lecturer-only: Do Not Disturb Settings */}
        {isLecturer && (
          <section style={{ marginTop: 20, background: 'white', border: '1px solid #e2e8f0', borderRadius: 16, padding: 20 }}>
            ...
            {saveStatus && (
              <div style={{
                ...
                <span className="system-body-regular">{saveStatus.message}</span>
              </div>
            )}
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <p style={{ margin: 0, color: '#64748b', fontSize: 13 }}>
                When enabled, students will receive your auto-reply message instead of directly pinging you in chats.
              </p>
            </div>
            ...
            {isLecturer && (
              <div>
                ...
                <p style={{ margin: '8px 0 0 0', color: '#64748b', fontSize: 12 }}>
                  This message will be automatically sent to students when they message you while DND is enabled.
                </p>
              </div>
            )}
      ...
      <main style={{ flex: 1, maxWidth: 860, margin: '0 auto', width: '100%', padding: '28px 16px' }}>
        ...
        <section style={{ marginTop: 14, background: 'white', border: '1px solid #e2e8f0', borderRadius: 16, padding: 24, textAlign: 'center' }}>
          ...
          <p style={{ margin: 0, color: '#64748b' }}>
            This button now works and routes correctly. The final business feature is the remaining part to implement.
          </p>
        </section>
      </main>
      <Footer />
