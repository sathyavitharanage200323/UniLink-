...
let fileContent = fs.readFileSync('src/pages/LecturerSlotsPage.jsx', 'utf8');
const originalOldReturn = fs.readFileSync('return_block_old.txt', 'utf8');
fileContent = fileContent.replace(originalOldReturn, replacement);
fs.writeFileSync('src/pages/LecturerSlotsPage.jsx', fileContent);
